...
# Carregar imagens
pinguim = carregar_imagem("C:/Projects/Aventuras do pinguim/pingo.png", (100, 100))
fundo_nivel_1 = carregar_imagem("C:/Projects/Aventuras do pinguim/fundoArtico.png", (largura_tela, altura_tela))
fundo_nivel_2 = carregar_imagem("C:/Projects/Aventuras do pinguim/fundofloresta.png", (largura_tela, altura_tela))
fundo_nivel_3 = carregar_imagem("C:/Projects/Aventuras do pinguim/fundoDeserto.png", (largura_tela, altura_tela))
fundo_menu = carregar_imagem("C:/Projects/Aventuras do pinguim/fundoInicio.png", (largura_tela, altura_tela))
fundo_fim_jogo = carregar_imagem("C:/Projects/Aventuras do pinguim/fundoFimJogo.png", (largura_tela, altura_tela))
fundo_vitoria = carregar_imagem("C:/Projects/Aventuras do pinguim/fundoVitoria.png", (largura_tela, altura_tela))
            ...
            if evento.type == pygame.KEYDOWN:
                if evento.key == pygame.K_UP:
                    ...
                    if indice_selecionado == 0:
                        jogo()  # Inicia o jogo sem o nome do jogador
                    elif indice_selecionado == 1:
                        pygame.quit()
                        return

        # Desenhar na tela apenas se a janela estiver aberta
    ...
    while jogando:
        ...
        if not fim_de_jogo:
            ...
            if pontos >= 1200:
                ...
                mostrar_texto("Carlos Athyla 2024", 50, PRETO, largura_tela // 2 - 150, altura_tela // 2 + 60, PRETO)
                pygame.display.update()
                time.sleep(5)
                return
